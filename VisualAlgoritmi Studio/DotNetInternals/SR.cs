...
namespace VisualAlgoritmi_Studio.DotNetInternals
{
    public static class SR
    {
        ...
        internal const string NotSupported_RangeCollection = "The specified operation is not supported on Ranges.";
        internal const string NotSupported_ReadOnlyCollection = "Collection is read-only.";
        internal const string InvalidOperation_UnderlyingArrayListChanged = "This range in the underlying list is invalid. A possible cause is that elements were removed.";
        ...
        internal const string InvalidOperation_IncompatibleComparer = "The collection's comparer does not support the requested operation.";
        internal const string SerializationException = "Serialization error.";
        internal const string Serialization_MissingKeys = "The Keys for this Hashtable are missing.";
