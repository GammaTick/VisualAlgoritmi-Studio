...
{
    public class ArrayListCanvas : VisualizerCanvasBase<VisualNode>
    {
        ...
        protected override void StepForwardCore(List<VisualNode> previousVisualState, IReadOnlyList<ICanvasOp> canvasOps)
        {
            foreach (var operation in canvasOps)
            {
                switch (operation)
                {
                    ...
                    case RemoveAtOperation removeAtOperation:
                        Remove(previousVisualState, removeAtOperation.Index);
                        break;
                    ...
                    case SetRangeOperation setRangeOperation:
                        SetRange(previousVisualState, setRangeOperation.StartIndex, setRangeOperation.Values);
                        break;
                    ...
                    case CreationFromCollectionOperation creationFromCollectionOperation:
                        AddRange(previousVisualState, creationFromCollectionOperation.Values);
                        break;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private void AddRange(List<VisualNode> previousVisualState, IReadOnlyList<string> values)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private void SetRange(List<VisualNode> previousVisualState, int index, IEnumerable<string> values)
        {
            double xOffset = previousVisualState[index].CellLocation.X;
