...
namespace VisualAlgoritmi_Studio.Controls.Canvas.Structures.List
{
    ...
    {
        public static readonly Type typeOfThis = typeof(VisualList<>);
...
#pragma warning restore CA1825, IDE0300
        ...
        public VisualList(IEnumerable<T> collection)
        {
            ...
            if (collection is ICollection<T> c)
            {
                ...
                else
                {
                    ...
                    var addRangeOp = CanvasOperationsHelper.GenerateAddRangeOperation(c);
                    _canvasOpLogger.Log(addRangeOp);
            ...
            else
            {
                ...
                _canvasOpLogger.BeginBatch(CanvasBatchKind.AddRange, 0);
        ...
        public void Add(T item)
        {
            ...
            if ((uint)size < (uint)array.Length)
            {
                ...
                _canvasOpLogger.Log(new AddOperation(item?.ToString() ?? "null"));
        ...
        public void AddRange(IEnumerable<T> collection)
        {
            ...
            {
                _canvasOpLogger.BeginBatch(CanvasBatchKind.AddRange, _size);
        ...
        public VisualList<TOutput> ConvertAll<TOutput>(Converter<T, TOutput> converter)
        {
            ...
            VisualList<TOutput> list = new VisualList<TOutput>(_size);
        ...
        public VisualList<T> FindAll(Predicate<T> match)
        {
            ...
            VisualList<T> list = new VisualList<T>();
            for (int i = 0; i < _size; i++)
            {
                if (match(_items[i]))
                {
        ...
        public void ForEach(Action<T> action)
        {
            ...
            var snapshot = CanvasOperationsHelper.GenerateSnapshotOperation(_items, _size, "Прилагане на действие към елементите");
        ...
        public VisualList<T> GetRange(int index, int count)
        {
            ...
            VisualList<T> list = new VisualList<T>(count);
        ...
        public VisualList<T> Slice(int start, int length) => GetRange(start, length);
        ...
        public void Insert(int index, T item)
        {
            ...
            _canvasOpLogger.Log(new InsertOperation(index, item?.ToString() ?? "null"));
            _canvasOpLogger.EndMultiOpStep();
        }
        ...
        public void InsertRange(int index, IEnumerable<T> collection)
        {
            ...
            if (collection is ICollection<T> c)
            {
                ...
                if (count > 0)
                {
                    ...
                    _canvasOpLogger.Log(new InsertRangeOperation(index, elements));
                    _canvasOpLogger.EndMultiOpStep();
            ...
            {
                _canvasOpLogger.BeginBatch(CanvasBatchKind.InsertRange, index);
        ...
        public int RemoveAll(Predicate<T> match)
        {
            ...
            var snapshot = CanvasOperationsHelper.GenerateSnapshotOperation(_items, _size, "Премахване на елементи по условие");
            _canvasOpLogger.Log(snapshot);
        ...
        public void Sort(int index, int count, IComparer<T>? comparer)
        {
            ...
            var snapshot = CanvasOperationsHelper.GenerateSnapshotOperation(_items, _size, $"Сортиране на {count} елемента от индекс {index}");
            _canvasOpLogger.Log(snapshot);
        }
        ...
        public void Sort(Comparison<T> comparison)
        {
            ...
            var snapshot = CanvasOperationsHelper.GenerateSnapshotOperation(_items, _size, "Сортиране на елементите с персонализирана функция за сравнение");
            _canvasOpLogger.Log(snapshot);
        }
        ...
        {
            private readonly VisualList<T> _list;
            private readonly int _version;

            private int _index;
            private T? _current;

            internal Enumerator(VisualList<T> list)
            {
                _list = list;
