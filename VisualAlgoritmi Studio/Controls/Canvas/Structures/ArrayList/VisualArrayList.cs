...
namespace VisualAlgoritmi_Studio.Controls.Canvas.Structures.ArrayList
{
    /// <summary>
    ...
    public class VisualArrayList : IList, ICloneable
    {
        public static readonly Type typeOfThis = typeof(VisualArrayList);
        ...
        // given collection.
        //
        public VisualArrayList(ICollection c)
        {
        ...
        public virtual int Capacity
        {
            ...
            set
            {
                ...
                if (value > 0)
                {
                    ...
                    _canvasOpLogger.Log(new CapacitySetOperation(value));
                }
                else
                {
                    _items = new object[_defaultCapacity];

                    _canvasOpLogger.Log(new CapacitySetOperation(_defaultCapacity));
                }
            }
        }
        ...
        public virtual object? this[int index]
        {
            ...
            set
            {
                ...
                _canvasOpLogger.Log(new SetOperation(index, value?.ToString() ?? "null"));
            }
        }
        ...
        //
        public static VisualArrayList Adapter(IList list)
        {
        ...
        public virtual int Add(object? value)
        {
            ...
            _canvasOpLogger.Log(new AddOperation(value?.ToString() ?? "null"));
        ...
        {
            VisualArrayList la = new VisualArrayList(_size);
            la._size = _size;
        ...
        public virtual void Insert(int index, object? value)
        {
            ...
            _canvasOpLogger.Log(new InsertOperation(index, value?.ToString() ?? "null"));
            _canvasOpLogger.EndMultiOpStep();
        }
        ...
        public virtual void InsertRange(int index, ICollection c)
        {
            ...
            if (count > 0)
            {
                ...
                var insertSnapshot = CanvasOperationsHelper.GenerateInsertRangeOperation(itemsToInsert, index);
                _canvasOpLogger.Log(insertSnapshot);
                _canvasOpLogger.EndMultiOpStep();
            }
        }
        ...
        public virtual void RemoveAt(int index)
        {
            ...
            _canvasOpLogger.Log(new RemoveOperation(index));
        }
        ...
        public virtual void RemoveRange(int index, int count)
        {
            ...
            if (count > 0)
            {
                ...
                _canvasOpLogger.Log(new RemoveRangeOperation(index, count));
            }
        }
        ...
        public static VisualArrayList Repeat(object? value, int count)
        {
            ...
            VisualArrayList list = new VisualArrayList((count > _defaultCapacity) ? count : _defaultCapacity);
        ...
        public virtual void Reverse(int index, int count)
        {
            ...
            _canvasOpLogger.Log(new ReverseOperation(index, count));
        }
        ...
        public virtual void SetRange(int index, ICollection c)
        {
            ...
            var snapshot = CanvasOperationsHelper.GenerateSetRangeOperation(c, index);
            _canvasOpLogger.Log(snapshot);
        }

        public virtual VisualArrayList GetRange(int index, int count)
        {
            ArgumentOutOfRangeException.ThrowIfNegative(index);
            ArgumentOutOfRangeException.ThrowIfNegative(count);
            if (_size - index < count)
        ...
        public virtual void Sort(int index, int count, IComparer? comparer)
        {
            ...
            var snapshot = CanvasOperationsHelper.GenerateSnapshotOperation(_items, _size, "Сортиране на всички елементи");
            _canvasOpLogger.Log(snapshot);
        }
        ...
        private sealed class IListWrapper : VisualArrayList
        {
            ...
            public override void InsertRange(int index, ICollection c)
            {
                ...
                if (c.Count > 0)
                {
                    if (_list is VisualArrayList al)
                    {
            ...
            public override VisualArrayList GetRange(int index, int count)
            {
                ArgumentOutOfRangeException.ThrowIfNegative(index);
                ArgumentOutOfRangeException.ThrowIfNegative(count);
                if (_list.Count - index < count)
        ...
        private sealed class SyncArrayList : VisualArrayList
        {
            private readonly VisualArrayList _list;
            private readonly object _root;

            internal SyncArrayList(VisualArrayList list)
            {
                _list = list;
                _root = list.SyncRoot;
            }
            ...
            public override object Clone()
            {
                lock (_root)
                {
                    return new SyncArrayList((VisualArrayList)_list.Clone());
                }
            }
        ...
        private sealed class FixedSizeArrayList : VisualArrayList
        {
            private VisualArrayList _list;

            internal FixedSizeArrayList(VisualArrayList l)
            {
                _list = l;
            ...
            public override object Clone()
            {
                ...
                arrayList._list = (VisualArrayList)_list.Clone();
                return arrayList;
            }
        ...
        private sealed class ReadOnlyArrayList : VisualArrayList
        {
            private VisualArrayList _list;

            internal ReadOnlyArrayList(VisualArrayList l)
            {
                _list = l;
            }
        ...
        private sealed class ArrayListEnumerator : IEnumerator, ICloneable
        {
            ...
            internal ArrayListEnumerator(VisualArrayList list, int index, int count)
            {
                _list = list;
                _startIndex = index;
                _index = index - 1;
        ...
        private sealed class Range : VisualArrayList
        {
            private VisualArrayList _baseList;
            private readonly int _baseIndex;
            private int _baseSize;
            private int _baseVersion;

            internal Range(VisualArrayList list, int index, int count)
            {
                _baseList = list;
                _baseIndex = index;
                _baseSize = count;
            ...
            public override object Clone()
            {
                ...
                arrayList._baseList = (VisualArrayList)_baseList.Clone();
                return arrayList;
            }
        ...
        private sealed class ArrayListEnumeratorSimple : IEnumerator, ICloneable
        {
            ...
            internal ArrayListEnumeratorSimple(VisualArrayList list)
            {
                _list = list;
                _index = -1;
                _version = list._version;
                _isArrayList = (list.GetType() == typeof(VisualArrayList));
        ...
        {
            private readonly VisualArrayList _arrayList;

            public ArrayListDebugView(VisualArrayList arrayList)
            {
