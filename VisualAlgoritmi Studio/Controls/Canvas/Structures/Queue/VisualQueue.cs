...
namespace VisualAlgoritmi_Studio.Controls.Canvas.Structures.Queue
{
    /// <summary>
    ...
    public class VisualQueue<T> : IEnumerable<T>,
        ICollection,
        IReadOnlyCollection<T>
    {
        public static readonly Type typeOfThis = typeof(VisualQueue<>);
        ...
        public VisualQueue(IEnumerable<T> collection)
        {
            ...
            var elements = CanvasOperationsHelper.GenerateSnapshotOperation(_array, _size, "Инициализиране на опашка от колекция");
        ...
        public void Enqueue(T item)
        {
            ...
            _canvasOpLogger.Log(new EnqueueOperation(item?.ToString() ?? "null"));
        ...
        public T Dequeue()
        {
            ...
            _canvasOpLogger.Log(new DequeueOperation());
        ...
        {
            private readonly VisualQueue<T> _queue;
            private readonly int _version;
            private int _i;
            private T? _currentElement;
 
            internal Enumerator(VisualQueue<T> queue)
            {
                _queue = queue;
